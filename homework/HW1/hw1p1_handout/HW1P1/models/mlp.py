...
class MLP0:
    ...
    def __init__(self, debug=False):
        ...
        # a list storing all linear layers
        self.layers = [Linear(2, 3)]
        # a list storing activation functions after each linear layer.
        self.f = [ReLU()]
    ...
    def backward(self, dLdA1):
        ...
        dLdZ0 = dLdA1 * dA1dZ0
        dLdA0, dLdW0, dLdb0 = self.layers[0].backward(dLdZ0)
...
class MLP1:
    ...
    def backward(self, dLdA2):
        ...
        dLdZ1 = dLdA2 * dA2dZ1
        dLdA1, _, _ = self.layers[1].backward(dLdZ1)

        dA1dZ0 = self.f[0].backward()
        dLdZ0 = dLdA1 * dA1dZ0
        dLdA0, _, _ = self.layers[0].backward(dLdZ0)
...
class MLP4:
    ...
    def backward(self, dLdA):
        ...
        for i in reversed(range(L)):
            ...
            dLdZ = dLdA * dAdZ
            dLdA, _, _ = self.layers[i].backward(dLdZ)
